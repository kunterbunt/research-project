folder = {['/home/kunterbunt/dev/omnetpp-5.0/samples/research-project/research-project/results/BandEffect-D2D-1RB-MD/']};   
titles = {['Max Datarate Scheduler: Band study, 1 RB/band']};  
